import {
    ...
    FETCH_MAATJAVALTIOTKOODISTO_FAILURE, FETCH_OPPILAITOSTYYPIT_REQUEST, FETCH_OPPILAITOSTYYPIT_SUCCESS,
...
export const fetchOppilaitostyypit = () => fetchGenericKoodisto(FETCH_OPPILAITOSTYYPIT_REQUEST,
    FETCH_OPPILAITOSTYYPIT_SUCCESS, FETCH_OPPILAITOSTYYPIT_FAILURE, 'koodisto-service.koodisto.oppilaitostyypit', 'oppilaitostyypit');

export const fetchOrganisaatiotyypit = () => fetchGenericKoodisto(FETCH_ORGANISAATIOTYYPIT_REQUEST,
    FETCH_ORGANISAATIOTYYPIT_SUCCESS, FETCH_ORGANISAATIOTYYPIT_FAILURE, 'koodisto-service.koodisto.organisaatiotyypit', 'organisaatiotyyppiKoodisto');
