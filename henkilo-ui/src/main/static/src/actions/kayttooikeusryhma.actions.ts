    ...
    http.get(url)
        .then(kayttooikeus => {
            dispatch(
                fetchOrganisations(
                    kayttooikeus.map(
                        kayttooikeus => kayttooikeus.organisaatioOid,
                    ),
                ),
            ).then(() =>
                dispatch(
                    receiveAllKayttooikeusryhmasForHenkilo(
                        henkiloOid,
                        kayttooikeus,
                    ),
                ),
...
const receiveAllKayttooikeusryhmaAnomusForHenkilo = (
    henkiloOid,
    kayttooikeusAnomus,
) => ({
...
export const fetchAllKayttooikeusAnomusForHenkilo = henkiloOid => dispatch => {
    ...
    http.get(url)
        .then(kayttooikeusAnomus => {
            dispatch(
                fetchOrganisations(
                    kayttooikeusAnomus.map(
                        koAnomus => koAnomus.anomus.organisaatioOid,
                    ),
                ),
            ).then(() =>
                dispatch(
                    receiveAllKayttooikeusryhmaAnomusForHenkilo(
                        henkiloOid,
                        kayttooikeusAnomus,
                    ),
                ),
        ...
        .catch(() =>
            dispatch(errorAllKayttooikeusryhmaAnomusForHenkilo(henkiloOid)),
        )
}
...
export const fetchOrganisaatioKayttooikeusryhmat = organisaatioOid => async dispatch => {
    ...
    try {
        ...
        dispatch(
            requestOrganisaatioKayttooikeusryhmatSuccess(kayttooikeusryhmat),
        )
    } catch (error) {
...
const requestAllowedKayttooikeusryhmasForOrganisation = (
    oidHenkilo,
    oidOrganisation,
) => ({
...
const receiveAllowedKayttooikeusryhmasForOrganisation = (
    oidHenkilo,
    oidOrganisation,
    allowedKayttooikeus,
) => ({
...
const errorAllowedKayttooikeusryhmasForOrganisation = (
    oidHenkilo,
    oidOrganisation,
) => ({
...
export const fetchAllowedKayttooikeusryhmasForOrganisation = (
    ...
    dispatch(
        requestAllowedKayttooikeusryhmasForOrganisation(
            oidHenkilo,
            oidOrganisation,
        ),
    )
    ...
    http.get(url, oidHenkilo, oidOrganisation)
        .then(allowedKayttooikeus =>
            dispatch(
                receiveAllowedKayttooikeusryhmasForOrganisation(
                    oidHenkilo,
                    oidOrganisation,
                    allowedKayttooikeus,
                ),
        ...
        .catch(() =>
            dispatch(
                errorAllowedKayttooikeusryhmasForOrganisation(
                    oidHenkilo,
                    oidOrganisation,
                ),
            ),
