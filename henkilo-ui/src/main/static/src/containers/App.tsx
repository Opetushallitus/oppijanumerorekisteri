...
class App extends React.Component<AppProps, AppState> {
        ...
        return this.isInitialized() ? (
            <div className="oph-typography mainContainer">
                <GlobalNotifications
                    ...
                    removeGlobalNotification={
                        this.props.removeGlobalNotification
                    }
                />
                <TopNavigation
    ...
    warnOnUnsupportedLocale(L: Localisations, locale: Locale) {
        if (
            !!L &&
            !!locale &&
            (!this.state.lastLocale || this.state.lastLocale !== locale)
        ) {
            this.setState({lastLocale: locale}, () => {
                if (
                    locale.toLowerCase() !== "fi" &&
                    locale.toLowerCase() !== "sv"
                ) {
...
export default connect<AppProps, OwnProps, _, _, _, _>(mapStateToProps, {
