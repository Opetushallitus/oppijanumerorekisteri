...
describe('Tests for PasswordValidator', () => {
    ...
    describe('containsSpecialCharacter', () => {
        it('should return whether given password contains at least one special character', () => {
            ...
            expect(containsSpecialCharacter('lök!asdf')).toBeTruthy();
        });
    });

    describe('containsForbiddenCharacter', () => {
        it('should return whether given password contains at least one forbidden character', () => {
            expect(hasForbiddenCharacters('abcd1234')).toBeFalsy();
            expect(hasForbiddenCharacters('ä')).toBeTruthy();
            expect(hasForbiddenCharacters('Å')).toBeTruthy();
            expect(hasForbiddenCharacters('-')).toBeTruthy();
        });
    });
    ...
    describe('isValidPassword', () => {
        it('should return whether given password is valid', () => {
            ...
            expect(isValidPassword('12345678901234567890A')).toBeFalsy();
            expect(isValidPassword('12345678901234567890Aa')).toBeTruthy();
            expect(isValidPassword('1234567890abcdeABCDE!')).toBeTruthy();
        });
    });
});
