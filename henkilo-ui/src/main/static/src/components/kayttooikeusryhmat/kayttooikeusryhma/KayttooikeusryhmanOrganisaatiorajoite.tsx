...
export default class KayttooikeusryhmanOrganisaatiorajoite extends React.Component<
    Props,
    State
> {
    state = {
        ...
        const organisaatiotyypitOptions: Array<ReactSelectOption> = this.props.koodisto.organisaatiotyyppiKoodisto.map(
            organisaatiotyyppi => ({
                label:
                    toLocalizedText(
                        this.props.locale,
                        organisaatiotyyppi.metadata,
                    ) || organisaatiotyyppi.koodiUri,
        ...
        return (
            <div className="kayttooikeusryhman-myonto-kohde">
                <h4>
                    {
                        this.props.L[
                            "KAYTTOOIKEUSRYHMAT_LISAA_ORGANISAATIORAJOITE_OTSIKKO"
                        ]
                    }
                </h4>
                <label className="oph-checkable" htmlFor="ryhmarestriction">
                    ...
                    <span className="oph-checkable-text">
                        {this.props.L["KAYTTOOIKEUSRYHMAT_LISAA_RYHMA"]}
                    </span>
                </label>
                ...
                <div className="flex-horizontal">
                    <div className="flex-item-1 ">
                        <OrganisaatioSelectModal
                            ...
                            disabled={
                                ...
                                this.props.organisaatios.length === 0
                            }
                        ...
                        <ItemList
                            ...
                            labelPath={["name"]}
                            removeAction={
                                this.props.removeOrganisaatioSelectAction
                            }
                        />
                    </div>
                    <div className="flex-item-1 oppilaitostyyppi-wrapper">
                        <OphCheckboxFieldset
                            legendText={
                                this.props.L[
                                    "KAYTTOOIKEUSRYHMAT_LISAA_VALITSE_OPPILAITOSTYYPPI"
                                ]
                            }
                            options={this.state.oppilaitostyypitOptions.map(
                                option => ({
                                    label: option.label,
                                    value: option.value,
                                    checked:
                                        this.props.oppilaitostyypitSelections &&
                                        this.props.oppilaitostyypitSelections.indexOf(
                                            option.value,
                                        ) !== -1,
                                }),
                            )}
                            selectAction={
                                this.props.oppilaitostyypitSelectAction
                            }
                        />
                    </div>
                    <div className="flex-item-1 organisaatiotyyppi-wrapper">
                        <OphCheckboxFieldset
                            legendText={
                                this.props.L[
                                    "KAYTTOOIKEUSRYHMAT_LISAA_VALITSE_ORGANISAATIOTYYPPI"
                                ]
                            }
                            options={this.state.organisaatiotyypitOptions.map(
                                option => ({
                                    label: option.label,
                                    value: option.value,
                                    checked:
                                        ...
                                        this.props.organisaatiotyypitSelections.indexOf(
                                            option.value,
                                        ) !== -1,
                                }),
                            )}
                            selectAction={
                                this.props.organisaatiotyypitSelectAction
                            }
                        />
                    </div>
                </div>
