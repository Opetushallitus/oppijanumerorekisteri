...
const KayttooikeusryhmatSallittuKayttajatyyppi = ({
    ...
    return (
        <div className="kayttooikeusryhmat-sallittu-kayttajatyyppi-wrapper">
            <span className="oph-h4 oph-bold">
                {L["KAYTTOOIKEUSRYHMAT_KAYTTAJATYYPPI_OTSIKKO"]}
            </span>
            <label
                className="oph-checkable oph-field-is-required"
                htmlFor="kayttooikeusryhmaKayttajatyyppi"
            >
                <input
                ...
                <span className="oph-checkable-text">
                    {L["KAYTTOOIKEUSRYHMAT_KAYTTAJATYYPPI_VAIN_PALVELU"]}
                </span>
            </label>
        </div>
    )
