...
export default class MyonnettavatKayttooikeusryhmat extends React.Component<
    Props,
    State
> {
    state = {
    ...
    render() {
        return (
            <div className="myonnettavat-kayttooikeusryhmat">
                <h4>
                    {this.props.L["KAYTTOOIKEUSRYHMAT_LISAA_MITA_SAA_MYONTAA"]}
                </h4>
                <div className="flex-horizontal">
                    <div className="flex-item-1">
                        <OphSelect
                            ...
                            placeholder={
                                this.props.L[
                                    "KAYTTOOIKEUSRYHMAT_LISAA_VALITSE_KAYTTOOIKEUSRYHMA"
                                ]
                            }
                        ...
                        <ItemList
                            ...
                            labelPath={["label"]}
                            removeAction={
                                this.props.removeKayttooikeusryhmaSelectAction
                            }
                        />
                    </div>
