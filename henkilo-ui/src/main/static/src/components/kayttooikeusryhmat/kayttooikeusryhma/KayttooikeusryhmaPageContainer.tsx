...
class KayttooikeusryhmaPageContainer extends React.Component<Props> {
    componentDidMount() {
        const kayttooikeusryhmaId: string | null | undefined = this.props
            .kayttooikeusryhmaId
        ...
        if (kayttooikeusryhmaId) {
            ...
            this.props.fetchPalveluRooliByKayttooikeusryhmaId(
                kayttooikeusryhmaId,
            )
    ...
    render() {
        return this.props.koodisto.oppilaitostyypitLoading ||
            ...
            (this.props.kayttooikeus.palvelutRoolitLoading &&
