...
export default class KayttooikeusryhmaLista extends React.Component<
    Props,
    State
> {
    state = {
                ...
                {this.props.items // Näytetäänkö vain palvelukäyttäjille vai virkailijoille
                    ...
                    .map((item: Kayttooikeusryhma, index: number) => {
                        ...
                        return (
                            <div
                                key={item.id}
                                className="kayttooikeuryhma-lista-item"
                            >
                                <div
    ...
    nimiFilter = (item: Kayttooikeusryhma) => {
        ...
        const nimi: Text | null | undefined = R.find(
    ...
    getStatusString = (kayttooikeusryhma: Kayttooikeusryhma) => {
        return kayttooikeusryhma.passivoitu
