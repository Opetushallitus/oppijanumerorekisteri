            ...
            return (
                <div className="virhePageVirheWrapperGray" id="virhePageVirhe">
                    <p className="oph-h2 oph-bold oph-red">
                        {
                            this.props.L[
                                "SAHKOPOSTI_VARMENNUS_TOKEN_YLEINEN_VIRHE_OTSIKKO"
                            ]
                        }
                    </p>
                    <p className="oph-bold">
                        {
                            this.props.L[
                                "SAHKOPOSTI_VARMENNUS_TOKEN_YLEINEN_VIRHE_TEKSTI"
                            ]
                        }
                    </p>
    ...
    redirectToFrontPage = async () => {
        try {
            ...
            this.props.router.push(
                `/sahkopostivarmistus/virhe/${this.props.locale}/${this.props.loginToken}/UNKNOWN`,
            )
        }
    }
}
