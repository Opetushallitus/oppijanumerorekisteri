...
class VtjVertailuPage extends React.Component<Props> {
        ...
        return this.props.henkilo.yksilointitiedotLoading ||
            ...
            <div className="wrapper">
                <p className="oph-h2 oph-bold">
                    {this.props.L["HENKILO_VTJ_VERTAILU"]}
                </p>
                <VtjVertailuListaus
                ...
                />
                <Button
                    action={this.overrideHenkiloInformation.bind(this)}
    ...
    async overrideHenkiloInformation(): Promise<any> {
        try {
            await this.props.overrideYksiloimatonHenkiloVtjData(
    ...
    isDisabled(): boolean {
        const hasAccess = hasAnyPalveluRooli(
        ...
        const currentUserIsViewedHenkilo =
            this.props.oidHenkilo === this.props.ownOid
        const isEnabledVtjVertailuView = enabledVtjVertailuView(
            this.props.henkilo.henkilo,
        )
        return (
            !isEnabledVtjVertailuView ||
            currentUserIsViewedHenkilo ||
            !hasAccess
        )
    }
}
