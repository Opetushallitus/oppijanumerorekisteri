...
const HenkiloViewContainer = () => {
    ...
    const yksiliontitiedotQuery = useGetYksilointitiedotQuery(oid);
    useNavigation(henkiloViewTabs(oid, henkilo, henkiloType, master?.oidHenkilo, yksiliontitiedotQuery.data), true);
