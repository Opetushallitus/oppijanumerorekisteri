        ...
        <div>
            <div className={styles.setupContainer}>
                <div className={styles.setupStep}>
                    ...
                    <div>
                        <div className={styles.setupStepInfo}>{L.MFA_LATAA_APP_INFO}</div>
                        <div>
                            <a
                ...
                <div className={styles.setupStep}>
                    ...
                    <div>
                        <div className={styles.setupStepInfo}>{L.MFA_LUE_QR_KOODI_INFO}</div>
                        <div>
                ...
                <div className={styles.setupStep}>
                    ...
                    <div>
                        <div className={styles.setupStepInfo}>{L.MFA_SYOTA_KOODI_INFO}</div>
                        <div>
                            <PinInput
                                length={6}
                                initialValue=""
