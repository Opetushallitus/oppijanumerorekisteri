...
class HenkiloViewDuplikaatit extends React.Component<Props, State> {
            ...
            <div className="duplicates-view">
                <div id="duplicates">
                    <div className="person header">
                        ...
                        <span>
                            {this.props.L["DUPLIKAATIT_MATKAPUHELINNUMERO"]}
                        </span>
                        <span>
                            {this.props.L["DUPLIKAATIT_SAHKOPOSTIOSOITE"]}
                        </span>
                        ...
                        <span>
                            {this.props.L["DUPLIKAATIT_HAKEMUKSENTILA"]}
                        </span>
                        <span>{this.props.L["DUPLIKAATIT_HAKEMUKSENOID"]}</span>
                        <span>
                            {this.props.L["DUPLIKAATIT_MUUTHAKEMUKSET"]}
                        </span>
                    </div>
                    <DuplikaatitPerson
                        henkilo={master}
                    ...
                    <LocalNotification
                        title={
                            this.props.L["DUPLIKAATIT_NOTIFICATION_EI_LOYTYNYT"]
                        }
    ...
    async _link() {
        ...
        await this.props.linkHenkilos(
            oid,
            this.state.selectedDuplicates,
            successMessage,
            failMessage,
        )
    ...
    setSelection(oid: string) {
        const selectedDuplicates = R.contains(
            oid,
            this.state.selectedDuplicates,
        )
            ? R.reject(
                  duplicateOid => duplicateOid === oid,
                  this.state.selectedDuplicates,
              )
