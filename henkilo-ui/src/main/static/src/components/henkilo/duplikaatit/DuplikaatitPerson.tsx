...
export default class DuplikaatitPerson extends React.Component<Props, State> {
    ...
    render() {
        ...
        const hakemukset = henkilo.hakemukset
            ? henkilo.hakemukset.map((hakemus: any) =>
                  this._parseHakemus(hakemus),
              )
            : undefined
        ...
        return (
            <div className={styleClasses}>
                ...
                <span>
                    {henkilo.yksiloity || henkilo.yksiloityVTJ
                        ? L["HENKILO_YHTEISET_KYLLA"]
                        : L["HENKILO_YHTEISET_EI"]}
                </span>
                ...
                <span>
                    <Link
                        className="oph-link"
                        to={`/${targetPage}/${henkilo.oidHenkilo}`}
                    >
                        {henkilo.oidHenkilo}
                    </Link>
                </span>
                ...
                {!this.props.vainLuku && (
                    <span>
                        <input
                            ...
                            disabled={
                                this.props.isMaster ||
                                (this.props.yksiloitySelected &&
                                    this.props.henkilo.yksiloity)
                            }
                            checked={this.state.checkboxValue}
                            onChange={this._onCheck.bind(
                                this,
                                henkilo.oidHenkilo,
                            )}
                        />
    ...
    _parseAtaruHakemus(hakemus: any): any {
        ...
        const aidinkieli = this._koodistoLabel(
            aidinkieliKoodi,
    ...
    _parseHakuappHakemus(hakemus: any): any {
        ...
        const aidinkieliKoodi = (
            henkilotiedot.aidinkieli || ""
        ).toLocaleLowerCase()
        const aidinkieli = this._koodistoLabel(
            aidinkieliKoodi,
            this.props.koodisto.kieli,
    ...
    _koodistoLabel(
        ...
        const koodistoItem = R.find(
            koodistoItem => koodistoItem.value === koodi,
            koodisto,
        )
