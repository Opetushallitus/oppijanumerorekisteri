...
import { PalvelukayttajaCreate } from '../../types/domain/kayttooikeus/palvelukayttaja.types';
import { Localisations } from '../../types/localisation.type';

type PalveluCreateFormProps = {
    onSubmit: (arg0: PalvelukayttajaCreate) => Promise<void>;
    L: Localisations;
};
            ...
            <form onSubmit={this.onSubmit}>
                <div className="oph-field oph-field-is-required">
                    <label htmlFor="nimi" className="oph-label">
                        {this.props.L['HENKILO_PALVELUN_NIMI']}
                    </label>
                    <input
                        id="nimi"
                        className="oph-input"
                ...
                <div className="oph-field">
                    <button type="submit" className="oph-button oph-button-primary" disabled={invalid}>
