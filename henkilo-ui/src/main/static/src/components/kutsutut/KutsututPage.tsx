...
export default class KutsututPage extends React.Component<Props, State> {
    ...
    componentDidUpdate(prevProps: Props, prevState: State) {
        ...
        if (
            Object.keys(this.state.payload).some(
                key => this.state.payload[key] !== prevState.payload[key],
            )
        ) {
            this.fetchKutsus()
        }
        ...
        this.setState({
            allFetched:
                ...
                (nextProps.kutsus.result.length < this.defaultLimit ||
                    nextProps.kutsus.result.length ===
                        this.props.kutsus.result.length),
        })
    }
            ...
            <div className="wrapper" id="kutsutut-page">
                <div className="header">
                    <span className="oph-h2 oph-bold">
                        {this.L["KUTSUTUT_VIRKAILIJAT_OTSIKKO"]}
                    </span>
                    <span className="right">
                        <KutsututBooleanRadioButton
                            view={this.state.payload.view}
                ...
                <div className="flex-horizontal flex-align-center kutsutut-filters">
                    <div className="flex-item-1">
                        <DelayedSearchInput
                            setSearchQueryAction={this.onHakutermiChange.bind(
                                this,
                            )}
                            defaultNameQuery={this.state.payload.searchTerm}
                            placeholder={
                                this.L["KUTSUTUT_VIRKAILIJAT_HAKU_HENKILO"]
                            }
                ...
                <div className="flex-horizontal kutsutut-filters">
                    <div className="flex-item-1 flex-inline">
                        <input
                            ...
                            placeholder={
                                this.L["KUTSUTUT_ORGANISAATIOSUODATUS"]
                            }
                            readOnly
                        />
                        <OrganisaatioSelectModal
                            ...
                            disabled={
                                ...
                                (this.props.organisaatiot &&
                                    this.props.organisaatiot.length === 0)
                            }
                        ...
                        <CloseButton
                            closeAction={() =>
                                this.clearOrganisaatioSelection()
                            }
                        ></CloseButton>
                    </div>
                    <div className="flex-item-1 flex-inline" id="radiator">
                        <div className="flex-item-1">
                            <KayttooikeusryhmaSingleSelect
                                kayttooikeusSelection={
                                    this.state.payload.kayttooikeusryhmaIds
                                }
                                kayttooikeusSelectionAction={this.onKayttooikeusryhmaChange.bind(
                                    this,
                                )}
                            />
                        </div>
                        <CloseButton
                            closeAction={() =>
                                this.clearKayttooikeusryhmaSelection()
                            }
                        ></CloseButton>
                    </div>
                </div>
                ...
                {this.state.confirmDeleteFor !== null && (
                    ...
                    >
                        <div className="confirmation-modal">
                            <span className="oph-h2 oph-strong">
                                {this.L["PERUUTA_KUTSU_VAHVISTUS"]}
                            </span>
                            <table>
                                <tbody>
                                    <tr>
                                    ...
                                    <tr>
                                        <th>
                                            {
                                                this.L[
                                                    "KUTSUTUT_ORGANISAATIO_OTSIKKO"
                                                ]
                                            }
                                        </th>
                                        <td>
                                            {this.state.confirmDeleteFor &&
                                                this.state.confirmDeleteFor.organisaatiot.map(
                                                    org => (
                                                        <div
                                                            className="kutsuOrganisaatio"
                                                            key={org.oid}
                                                        >
                                                            {
                                                                org.nimi[
                                    ...
                                    <tr>
                                        <th>
                                            {
                                                this.L[
                                                    "KUTSUTUT_KUTSU_LAHETETTY_OTSIKKO"
                                                ]
                                            }
                                        </th>
                                        <td>
                            ...
                            <div className="row">
                                <Button
                                    ...
                                    action={this.cancelInvitationConfirmed.bind(
                                        this,
                                    )}
                                >
                                ...
                                <Button
                                    ...
                                    action={this.cancelInvitationCancellation.bind(
                                        this,
                                    )}
                                >
    ...
    parseOrganisaatioSelectObjects(
        organisaatiot: Array<OrganisaatioHenkilo>,
    ): Array<OrganisaatioSelectObject> {
        return omattiedotOrganisaatiotToOrganisaatioSelectObject(
            organisaatiot,
            this.props.locale,
        )
    }
    ...
    fetchKutsus(
        ...
        shouldNotClear: boolean | null | undefined,
    ) {
        ...
        this.setState(
            {payload: {...this.state.payload, sortBy, direction}},
            () =>
