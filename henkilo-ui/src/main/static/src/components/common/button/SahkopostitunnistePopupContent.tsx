                ...
                <ul>
                    {this.state.loading ? (
                        ...
                        this.state.tunnisteet
                            ...
                            .map(tunniste => (
                                <li
                                    className="tunnistetag"
                                    key={tunniste.identifier}
                                >
                        ...
                        <span className="oph-h4 oph-strong">
                            {this.props.L["EI_SAHKOPOSTITUNNISTEITA"]}
                        </span>
                    )}
                </ul>
    ...
    async addSahkopostitunniste() {
        if (this.state.newTunniste.length > 0) {
            ...
            try {
                ...
                const newTunnisteet = await http.post(
                    url,
