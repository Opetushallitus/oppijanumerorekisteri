...
class HakatunnistePopupContent extends React.Component<Props, State> {
        ...
        return (
            <div className="hakapopupcontent">
                        ...
                        this.state.hakatunnisteet.map((
                            ...
                            <li className="tag" key={hakatunniste}>
                                ...
                                <a
                                    className="remove"
                                    onClick={() =>
                                        this.removeHakatunniste(hakatunniste)
                                    }
                                >
                                    {this.props.L["POISTA"]}
                                </a>
                ...
                <div className="oph-field oph-field-is-required">
                    ...
                    />
                    {this.state.hakatunnisteet.includes(
                        this.state.newTunnisteValue,
                    ) ? (
                    ...
                    <button
                        ...
                        disabled={this.state.hakatunnisteet.includes(
                            this.state.newTunnisteValue,
                        )}
    ...
    async removeHakatunniste(tunniste: string) {
        const filteredTunnisteet = reject(
            hakatunniste => hakatunniste === tunniste,
        )(this.state.hakatunnisteet)
    ...
    async saveHakatunnisteet(
        newHakatunnisteet: Array<string>,
        newTunnisteValue: string,
    ) {
        ...
        try {
            ...
            if (
                ...
                error.message.indexOf("ovat jo käytössä") !== -1
            ) {
