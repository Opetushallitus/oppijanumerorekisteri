...
class PopupButton extends React.Component<Props, State> {
    ...
    render(): Node {
        const wrapperStyle = this.props.popupButtonWrapperPositioning
    ...
    createPopup() {
        ...
        const popupClass: string = this.props.popupClass
            ? this.props.popupClass
            : this.state.defaultPopupClass

        return (
            <div
                className={`oph-popup ${popupClass} popup-paddings`}
                style={this.props.popupStyle}
            >
                <div
                    className="oph-popup-arrow"
                    style={this.props.popupArrowStyles}
                ></div>
