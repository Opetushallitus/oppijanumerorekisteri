...
class HenkiloViewExistingKayttooikeus extends React.Component<Props, State> {
    ...
    constructor(props: Props) {
        ...
        this.headingList = [
            ...
            },
            {
                ...
                minWidth: 125,
                Cell: cellProps =>
                    cellProps.value.kasitelty.format() +
                    " / " +
                    cellProps.value.kasittelija,
                sortMethod: (a, b) => {
                    const kasiteltyCompare =
                        a.kasitelty.valueOf() - b.kasitelty.valueOf()
            ...
            dates: this.props.kayttooikeus.kayttooikeus
                ...
                .map(kayttooikeusAnomus => ({
                    ...
                    loppupvm: this.props.vuosia
                        ...
                        : moment(
                              kayttooikeusAnomus.voimassaPvm,
        ...
        this._rows = this.props.kayttooikeus.kayttooikeus
            ...
            .map((uusittavaKayttooikeusRyhma, idx) => {
                const organisaatio =
                    ...
                    StaticUtils.defaultOrganisaatio(
                        uusittavaKayttooikeusRyhma.organisaatioOid,
                        this.props.l10n,
                    )
                return {
                    ...
                    [headingList[4]]: {
                        ...
                        kasittelija:
                            uusittavaKayttooikeusRyhma.kasittelijaNimi ||
                    ...
                    [headingList[7]]: this.props.notifications.existingKayttooikeus.some(
                        notification => {
                            return (
                    ...
                    [headingList[8]]: (
                        <div>
                            ...
                            <HaeJatkoaikaaButton
                                haeJatkoaikaaAction={() =>
                                    this._createKayttooikeusAnomus(
                                        uusittavaKayttooikeusRyhma,
                                        idx,
                                    )
                                }
            ...
            [
                {
                    id,
                    kayttooikeudenTila,
                    alkupvm: moment(this.state.dates[idx].alkupvm).format(
                        PropertySingleton.state.PVM_DBFORMAATTI,
                    ),
                    loppupvm: moment(this.state.dates[idx].loppupvm).format(
                        PropertySingleton.state.PVM_DBFORMAATTI,
                    ),
                },
            ],
    ...
    isHaeJatkoaikaaButtonDisabled(
        idx: number,
        uusittavaKayttooikeusRyhma: MyonnettyKayttooikeusryhma,
    ) {
        ...
        return (
            this.state.emailSelection[idx].value === "" ||
            ...
            <div className="henkiloViewUserContentWrapper">
                <div className="header">
                    <p className="oph-h2 oph-bold">
                        {this.L["HENKILO_OLEVAT_KAYTTOOIKEUDET_OTSIKKO"]}
                    </p>
                </div>
                <Notifications
                    notifications={
                        this.props.notifications.existingKayttooikeus
                    }
                    L={this.L}
                    closeAction={(status, id) =>
                ...
                />
                {this.props.isOmattiedot &&
                this.state.showMissingEmailNotification ? (
                    <WideBlueNotification
                        message={
                            this.L[
                                "OMATTIEDOT_PUUTTUVA_SAHKOPOSTI_OLEMASSAOLEVA_KAYTTOOIKEUS"
                            ]
                        }
                        closeAction={() => {
                ...
                <div>
                    <Table
                        ...
                        data={this._rows}
                        noDataText={
                            this.L["HENKILO_KAYTTOOIKEUS_VOIMASSAOLEVAT_TYHJA"]
                        }
                    />
                </div>
            </div>
