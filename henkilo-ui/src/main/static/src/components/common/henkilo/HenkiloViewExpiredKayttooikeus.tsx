...
class HenkiloViewExpiredKayttooikeus extends React.Component<Props, State> {
    ...
    createRows(headingList: Array<string>) {
        this._rows = this.props.kayttooikeus.kayttooikeus
            ...
            .map(
                (
                    vanhentunutKayttooikeus: MyonnettyKayttooikeusryhma,
                    idx: number,
                ) => ({
                    [headingList[0]]: toLocalizedText(
                        ...
                        (
                            this.props.organisaatioCache[
                                vanhentunutKayttooikeus.organisaatioOid
                            ] ||
                    ...
                    [headingList[3]]: {
                        ...
                        kasittelija:
                            vanhentunutKayttooikeus.kasittelijaNimi ||
                            vanhentunutKayttooikeus.kasittelijaOid,
                    },
                    [headingList[4]]: vanhentunutKayttooikeus.tila ===
                        KAYTTOOIKEUDENTILA.VANHENTUNUT &&
                        !this.hideVanhentunutKayttooikeusUusintaButton(
                ...
                <div>
                    <div className="header">
                        <p className="oph-h2 oph-bold">
                            {this.L["HENKILO_VANHAT_KAYTTOOIKEUDET_OTSIKKO"]}
                        </p>
                    </div>
                    <div>
                        <Table
                            ...
                            noDataText={
                                this.L[
                                    "HENKILO_KAYTTOOIKEUS_SULKEUTUNEET_TYHJA"
                                ]
                            }
                        />
                    </div>
    ...
    hideVanhentunutKayttooikeusUusintaButton(
        vanhentunutKayttooikeus: MyonnettyKayttooikeusryhma,
    ) {
        ...
        return !!this.props.kayttooikeus.kayttooikeus
            ...
            .reduce(
                (previous: boolean, current: MyonnettyKayttooikeusryhma) => {
                    return (
                        previous ||
                        (current.organisaatioOid ===
                            vanhentunutKayttooikeus.organisaatioOid &&
    ...
    isHaeJatkoaikaaButtonDisabled(
        idx: number,
        vanhentunutKayttooikeusryhma: MyonnettyKayttooikeusryhma,
    ) {
        const anomusAlreadyExists = !!this.props.kayttooikeus.kayttooikeusAnomus.filter(
            haettuKayttooikeusRyhma =>
                haettuKayttooikeusRyhma.kayttoOikeusRyhma.id ===
                    vanhentunutKayttooikeusryhma.ryhmaId &&
                vanhentunutKayttooikeusryhma.organisaatioOid ===
