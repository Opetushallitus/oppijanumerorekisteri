...
class AdminUserContent extends React.Component<Props, State> {
    ...
    createReadOnlyButtons = () => {
        ...
        const buttonPopupStyles = {left: '0px', top: '3rem', width: '15rem', padding: '30px'};
        ...
        const poistaKayttajatunnusBtn = isOnrRekisterinpitaja && !kayttajatunnukseton ? <PoistaKayttajatunnusButton /> : null;
        ...
        const hakaButton = <HakaButton oidHenkilo={this.props.oidHenkilo} styles={buttonPopupStyles} disabled={duplicate || passivoitu} />;
        const sahkopostiTunnisteButton = isOnrRekisterinpitaja ? <SahkopostitunnisteButton oidHenkilo={this.props.oidHenkilo} styles={buttonPopupStyles}></SahkopostitunnisteButton> : null;
