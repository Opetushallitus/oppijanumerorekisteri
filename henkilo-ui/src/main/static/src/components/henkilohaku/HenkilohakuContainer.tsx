...
import {
    ...
    henkilohakuCount,
    updateFilters,
} from "../../actions/henkilohaku.actions"
...
import {
    parsePalveluRoolit,
    hasAnyPalveluRooli,
} from "../../utilities/palvelurooli.util"
    ...
    render() {
        return !this.props.allKayttooikeusryhmasLoading &&
            ...
            <HenkilohakuPage
                ...
                henkilohakuLoading={
                    this.props.henkilohakuState.henkilohakuLoading
                }
...
const mapStateToProps = (state, ownProps) => {
    return {
        ...
        allKayttooikeusryhmasLoading:
            state.kayttooikeus.allKayttooikeusryhmasLoading,
