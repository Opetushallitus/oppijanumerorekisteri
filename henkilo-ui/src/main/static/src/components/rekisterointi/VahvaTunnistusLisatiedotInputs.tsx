...
class VahvaTunnistusLisatiedotInputs extends React.Component<
    VahvaTunnistusLisatiedotInputsProps
> {
    render() {
        return (
            <div>
                {this.props.form.metadata.password.visible && (
                    <OphField
                        required={this.props.form.metadata.password.required}
                    >
                        <OphLabel for="password" inline={true}>
                            {
                                this.props.L[
                                    "UUDELLEENREKISTEROINTI_UUSI_SALASANA"
                                ]
                            }
                        </OphLabel>
                        <Salasana
                            disabled={
                                this.props.form.metadata.password.disabled
                            }
                            isError={this.hasError("password")}
                            L={this.props.L}
                            updateModelFieldAction={this.onInputChange.bind(
                                this,
                            )}
                        />
                        <LocalNotification
                            type="error"
                            title={
                                this.props.L["LOMAKE_KENTTA_SISALTAA_VIRHEITA"]
                            }
                ...
                {this.props.form.metadata.tyosahkopostiosoite.visible && (
                    <OphField
                        required={
                            this.props.form.metadata.tyosahkopostiosoite
                                .required
                        }
                    >
                        <OphLabel for="tyosahkopostiosoite">
                            {
                                this.props.L[
                                    "UUDELLEENREKISTEROINTI_SAHKOPOSTIOSOITE"
                                ]
                            }
                        </OphLabel>
                        <OphInput
    ...
    hasError = (name: string): boolean => {
        return (
            ...
            this.props.form.errors.some(error => error.name === name)
        )
    }
