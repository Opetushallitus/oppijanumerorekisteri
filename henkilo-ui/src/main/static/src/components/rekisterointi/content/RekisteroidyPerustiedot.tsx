...
class RekisteroidyPerustiedot extends React.Component<Props> {
                ...
                {this.props.henkilo && (
                    <div>
                        <p className="oph-h3 oph-bold">
                            {this.props.L["REKISTEROIDY_PERUSTIEDOT"]}
                        </p>
                        ...
                        <Kutsumanimi
                            ...
                            autoFocus
                            defaultValue={
                                this.props.henkilo.henkilo.kutsumanimi
                            }
                            updateModelFieldAction={
                                this.props.updatePayloadModel
                            }
                        ...
                        <Kayttajanimi
                            disabled={false}
                            defaultValue={
                                this.props.henkilo.henkilo.kayttajanimi
                            }
                            updateModelFieldAction={
                                this.props.updatePayloadModel
                            }
                            isError={
                                this.isKayttajanimiError() ||
                                this.props.isUsernameError
                            }
                        />
                        <Salasana
                            disabled={false}
    ...
    isSalasanaError() {
        return !!this.props.notifications.filter(
            notification =>
                notification.id === "rekisteroidyPage" &&
                notification.errorType === "PasswordException",
        )[0]
    }
}
