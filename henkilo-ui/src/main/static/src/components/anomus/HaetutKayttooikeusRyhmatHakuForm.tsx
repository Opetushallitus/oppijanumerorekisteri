...
class HaetutKayttooikeusRyhmatHakuForm extends React.Component<Props, State> {
        ...
        return (
            <form>
                <div className="flex-horizontal flex-align-center">
                    ...
                    >
                        <DelayedSearchInput
                            ...
                            placeholder={
                                this.props.L[
                                    "HAETTU_KAYTTOOIKEUSRYHMA_HAKU_HENKILO"
                                ]
                            }
                    ...
                    <div className="flex-item-1 haetut-kayttooikeusryhmat-form-item flex-inline large-kayttooikeus-filter">
                        <input
                            ...
                            type="text"
                            value={
                                this.state.selectedOrganisaatio
                                    ? this.state.selectedOrganisaatio.name
                                    : ""
                            }
                            placeholder={
                                this.props.L[
                                    "HAETTU_KAYTTOOIKEUSRYHMA_HAKU_ORGANISAATIO"
                                ]
                            }
                            readOnly
                        />
                        ...
                        <span className="haetut-kayttooikeusryhmat-close-button">
                            <CloseButton
                                closeAction={() => this.onClearOrganisaatio()}
                            />
                        </span>
                    </div>
                </div>
                <div className="flex-horizontal flex-align-center margin-top-5">
                    {this.props.isAdmin || this.props.isOphVirkailija ? (
                        <div className="flex-item-1 haetut-kayttooikeusryhmat-form-item flex-inline large-kayttooikeus-filter">
                            <span className="flex-item-1">
                                <OphSelect
                                    id="ryhmafilter"
                                    options={this._parseRyhmas(
                                        this.props.ryhmat,
                                    )}
                                    value={this.state.selectedRyhma}
                                    placeholder={
                                        this.props.L[
                                            "HAETTU_KAYTTOOIKEUSRYHMA_HAKU_RYHMA"
                                        ]
                                    }
                    ...
                    {this.props.isAdmin && (
                        <div
                            id="kayttooikeusryhmaRadioButtonWrapper"
                            className="haetut-kayttooikeusryhmat-form-item"
                        >
                            <BooleanRadioButtonGroup
                                ...
                                trueLabel={
                                    this.props.L[
                                        "HAETTU_KAYTTOOIKEUSRYHMA_HAKU_NAYTA_KAIKKI"
                                    ]
                                }
                                falseLabel={
                                    this.props.L[
                                        "HAETTU_KAYTTOOIKEUSRYHMA_HAKU_NAYTA_OPH"
                                    ]
                                }
                            />
                        </div>
    ...
    onRyhmaChange = (
        ryhma: {label: string; value: string} | null | undefined,
    ) => {
