            ...
            <form>
                <div className="flex-horizontal flex-align-center">
                    ...
                    <div className="flex-item-1 haetut-kayttooikeusryhmat-form-item flex-inline large-kayttooikeus-filter">
                        <input class="oph-input flex-item-1" type="text" value={this.state.selectedOrganisaatio ? this.state.selectedOrganisaatio.name : ''} placeholder={this.props.L['HAETTU_KAYTTOOIKEUSRYHMA_HAKU_ORGANISAATIO']} readOnly/>
