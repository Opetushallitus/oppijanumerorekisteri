...
export default class AnomusHylkaysPopup extends React.Component<Props, State> {
    ...
    render() {
        return <div className="anomus-hylkays-popup">
            ...
            <button className="oph-button oph-button-confirm" style={{textAlign: 'left'}}
                    onClick={() => {this.props.action(this.props.kayttooikeusryhmaId, 'HYLATTY', this.props.index, this.props.henkilo, this.state.hylkaysperuste)}}>
