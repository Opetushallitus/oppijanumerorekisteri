        ...
        return (
            <fieldset className="add-to-organisation">
                <span className="oph-h2 oph-strong">
                    {this.props.L["VIRKAILIJAN_LISAYS_ORGANISAATIOON_OTSIKKO"]}
                </span>
                <AddedOrganizations addedOrgs={this.props.addedOrgs} />
                <div className="row">
                    <Button
                        href="#"
                        action={this.addEmptyOrganization.bind(this)}
                    >
                        {
                            this.props.L[
                                "VIRKAILIJAN_KUTSU_LISAA_ORGANISAATIO_LINKKI"
                            ]
                        }
                    </Button>
                </div>
