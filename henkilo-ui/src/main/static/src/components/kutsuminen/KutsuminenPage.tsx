...
class KutsuminenPage extends React.Component<Props, State> {
        ...
        this.initialValidationMessages = {
            organisaatioKayttooikeus: {
                ...
                labelLocalised: this.props.L[
                    "VIRKAILIJAN_LISAYS_VALITSE_VAH_ORGANISAATIO_JA_YKSI_OIKEUS"
                ],
                isValid: false,
            },
            allFilled: {
                id: "allFilled",
                labelLocalised: this.props.L[
                    "VIRKAILIJAN_LISAYS_TAYTA_KAIKKI_KENTAT"
                ],
                isValid: false,
            },
            sahkoposti: {
                id: "sahkoposti",
                labelLocalised: this.props.L[
                    "VIRKAILIJAN_LISAYS_SAHKOPOSTI_VIRHEELLINEN"
                ],
                isValid: true,
            },
        }
    ...
    render() {
        ...
        if (
            this.props.omattiedotLoading ||
            this.props.henkiloLoading ||
            this.props.ryhmasLoading
        ) {
            return (
                ...
                <div>
                    <form className="wrapper">
                        <p className="oph-h2 oph-bold">
                            {this.props.L["VIRKAILIJAN_LISAYS_OTSIKKO"]}
                        </p>
                        <LocalNotification
                            type="error"
                            title={this.props.L["KUTSU_ESTETTY"]}
                            toggle={disabled}
                        >
                        ...
                        <div className="kutsuFormFooter row">
                            <ValidationMessageButton
                                buttonAction={this.openConfirmationModal.bind(
                                    this,
                                )}
                                validationMessages={
    ...
    isOrganizationsValid(newAddedOrgs: Array<KutsuOrganisaatio>): boolean {
        return (
            ...
            newAddedOrgs.every(
                org =>
                    StaticUtils.stringIsNotEmpty(org.oid) &&
                    org.selectedPermissions.length > 0,
            )
        )
    }
