...
export const enabledVtjVertailuView = (henkilo: Henkilo): boolean =>
    henkilo &&
    henkilo.yksilointiYritetty &&
    !henkilo.yksiloityVTJ &&
    !henkilo.duplicate
export const vtjDataAvailable = (
    yksilointitieto: Yksilointitieto | null | undefined,
): boolean =>
...
export const henkiloViewTabs = (
    ...
    const tabs =
        henkiloType === "virkailija"
            ? virkailijaNavi(oidHenkilo)
            : oppijaNavi(oidHenkilo)
    ...
    if (
        (henkilo &&
            ...
            henkilo.master.oidHenkilo !== oidHenkilo) ||
        (henkilo &&
            henkilo.henkiloLoading &&
            henkilo.henkilo.oidHenkilo !== oidHenkilo) ||
