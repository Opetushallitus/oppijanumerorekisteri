...
export const createEmailOptions = (henkilo: HenkiloState, filterKayttooikeusRyhma: (kayttooikeus: MyonnettyKayttooikeusryhma) => boolean,
                                   kayttooikeusryhmat: Array<MyonnettyKayttooikeusryhma>): CreateEmailOptions => {
