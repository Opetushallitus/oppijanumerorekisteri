 ...
 */
export const validateYhteystiedotRyhmaEmails = (
    yhteystiedotRyhma: Array<YhteystietoRyhma>,
): boolean => {
    return yhteystiedotRyhma
        .map(validYhteystietoRyhma)
 ...
 */
export const validYhteystietoRyhma = (
    yhteystietoRyhma: YhteystietoRyhma,
): boolean => {
...
export const validEmailYhteystieto = (yhteystieto: Yhteystieto): boolean => {
    const email: string = yhteystieto.yhteystietoArvo
 ...
 */
export const notEmptyYhteystiedotRyhmaEmailCount = (
    yhteystiedotRyhma: Array<YhteystietoRyhma>,
): number => {
    return yhteystiedotRyhma
 ...
 */
export const notEmptyYhteystietoRyhmaEmailCount = (
    yhteystietoRyhma: YhteystietoRyhma,
): number => {
    return yhteystietoRyhma.yhteystieto
        .filter(
 ...
 */
export const isNotEmptyYhteystietoEmail = (
    yhteystieto: Yhteystieto,
): boolean => {
    const email: string = yhteystieto.yhteystietoArvo
        ? yhteystieto.yhteystietoArvo
