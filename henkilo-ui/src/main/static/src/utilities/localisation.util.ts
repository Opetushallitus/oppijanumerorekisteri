...
export const localizeTextGroup = (texts: Array<Text>, locale: Locale): string | null | undefined => {
    if (isEmpty(texts) || texts === undefined || texts === null) {
        return undefined;
    }

    const lang = locale.toUpperCase();
    const localizedText: Text | null | undefined = texts.find((text) => text.lang.toUpperCase() === lang);
