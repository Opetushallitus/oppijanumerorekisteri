...
export const parsePalveluRoolit = (organisaatiot: Array<KayttooikeusOrganisaatiot>): Array<string> => {
    return organisaatiot.map( (organisaatio: KayttooikeusOrganisaatiot) => organisaatio.kayttooikeudet
        .map( (kayttooikeus: KayttooikeusOikeudet) => `${kayttooikeus.palvelu}_${kayttooikeus.oikeus}`))
 ...
 */
export const hasPalveluRooliByOrganisaatioOid = (organisaatiot: Array<KayttooikeusOrganisaatiot>, organisaatioOid: string, palveluRooli: string): boolean => {
 ...
 */
export const hasAnyPalveluRooli = (organisaatiot: Array<KayttooikeusOrganisaatiot>, palveluRoolit: Array<string>): boolean => {
 ...
 */
export const organisaatioContainsAnyPalveluRooli = (organisaatio: KayttooikeusOrganisaatiot, palveluRoolit: Array<string>): boolean => {
    return organisaatio.kayttooikeudet.some( (kayttooikeus: KayttooikeusOikeudet) => kayttooikeusMatchesAnyPalveluRooli(kayttooikeus, palveluRoolit));
};

/*
 * Check if KayttooikeusOikeudet contains any of the given palvelurooli
 */
export const kayttooikeusMatchesAnyPalveluRooli = (kayttooikeus: KayttooikeusOikeudet, palveluRoolit: Array<string>): boolean => {
