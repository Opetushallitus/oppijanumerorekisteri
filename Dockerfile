FROM maven:3.9.16-amazoncorretto-21@sha256:f39bfb9b2aa9d277f9971bb86f061e4db3b6e31340d466c5d5e2dd88734bc129 AS build
WORKDIR /app

COPY . .
RUN mvn --batch-mode clean package -s codebuild-mvn-settings.xml -DskipTests

FROM amazoncorretto:21.0.11@sha256:975b191f99b2f0fb9e76397b7d85523e9904dcb679e54d5f9099c1cdeab21cf1
WORKDIR /app
