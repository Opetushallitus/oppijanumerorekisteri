...
public class CasClient {
    ...
    public CasClient(HttpClient httpClient, String baseUrl) {
        log.info("Initializing CasClient for CAS server at {}", baseUrl);
        this.baseUrl = baseUrl;
        this.httpClient = httpClient;
    }

    public String getTicket(String username, String password, String service) {
        try {
    ...
    private String getServiceTicket(String username, String password, String service) throws IOException, InterruptedException {
