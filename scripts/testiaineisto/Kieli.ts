...
//
//   const kieli = Convert.toKieli(json);
//
...
export class Convert {
    public static toKieli(json: string): Kieli[] {
        return cast(JSON.parse(json), a(r("Kieli")));
    }

    public static kieliToJson(value: Kieli[]): string {
        return JSON.stringify(uncast(value, a(r("Kieli"))), null, 2);
    }
}
...
const typeMap: any = {
    "Kieli": o([
        ...
        { json: "paivittajaOid", js: "paivittajaOid", typ: u(null, "") },
