...
ssm_target="$( aws ec2 describe-instances --filters 'Name=tag:Name,Values=OppijanumerorekisteriBastion' --query 'Reservations[0].Instances[0].InstanceId' --output text )"
