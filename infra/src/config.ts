...
export type Config = {
  ...
  features: {
    ...
    "oppijanumerorekisteri.tasks.henkilo-export.enabled": boolean;
    "oppijanumerorekisteri.tasks.koski-datantuonnin-muokkaus.enabled": boolean;
    "oppijanumerorekisteri.tasks.audit-cleanup.enabled": boolean;
  };
  lampiExport?: {
    enabled: boolean;
    bucketName: string;
