...
INSERT INTO yhteystiedotryhma (id, version, henkilo_id, ryhmakuvaus, read_only) VALUES
(-1, 0, (SELECT id FROM henkilo where oidhenkilo = 'Tyoosoite'), 'yhteystietotyyppi2', FALSE);
...
INSERT INTO yhteystiedotryhma (id, version, henkilo_id, ryhmakuvaus, read_only) VALUES
(-2, 0, (SELECT id FROM henkilo where oidhenkilo = 'TyoosoiteVainLuku'), 'yhteystietotyyppi2', TRUE);
INSERT INTO yhteystiedot (id, version, yhteystiedotryhma_id, yhteystieto_tyyppi, yhteystieto_arvo) VALUES
(-2, 0, (SELECT MIN(id) FROM yhteystiedotryhma), 'YHTEYSTIETO_SAHKOPOSTI', 'tyoosoite@example.com');

INSERT INTO yhteystiedotryhma (id, version, henkilo_id, ryhmakuvaus, read_only) VALUES
(-3, 0, (SELECT id FROM henkilo where oidhenkilo = 'Kotiosoite'), 'yhteystietotyyppi1', FALSE);
INSERT INTO yhteystiedot (id, version, yhteystiedotryhma_id, yhteystieto_tyyppi, yhteystieto_arvo) VALUES
