...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.NONE, classes = {OppijanumerorekisteriServiceApplication.class, H2Configuration.class, CustomFilterConfiguration.class})
