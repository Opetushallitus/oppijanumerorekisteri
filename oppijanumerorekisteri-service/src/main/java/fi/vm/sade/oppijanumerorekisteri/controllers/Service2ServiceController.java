...
public class Service2ServiceController {
    ...
    @Operation(summary ="Hakee hetu & oid -yhdistelmät")
    @PreAuthorize("hasAnyRole('APP_OPPIJANUMEROREKISTERI_REKISTERINPITAJA'," +
            "'APP_OPPIJANUMEROREKISTERI_REKISTERINPITAJA_READ')")
    ...
    public List<HenkiloHetuAndOidDto> hetusAndOidsOrderedByLastVtjSyncTimestamp(
            @Parameter(description = "Hakee vain ne identiteetit, jotka on päivitetty VTJ:stä ennen annettua ajanhetkeä")
    ...
    @Operation(summary ="Päivittää henkilön tietoja muutostietopalvelun antamilla muutoksilla.",
            description = "Päivittää kutsussa annettuun OID:n täsmäävän henkilön tiedot")
    @PreAuthorize("hasAnyRole('APP_OPPIJANUMEROREKISTERI_MUUTOSTIETOPALVELU')")
