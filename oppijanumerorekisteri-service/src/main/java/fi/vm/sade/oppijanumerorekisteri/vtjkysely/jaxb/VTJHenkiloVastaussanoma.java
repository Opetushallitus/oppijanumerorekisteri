...
public class VTJHenkiloVastaussanoma {
    ...
    public static class Henkilo {
         ...
         * This is why there is not a {@code set} method for the entinenNimi property.</p>
         * 
         * <p>
         ...
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the Jakarta XML Binding object.
         * This is why there is not a {@code set} method for the tilapainenKotimainenOsoite property.</p>
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * </p>
         ...
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the Jakarta XML Binding object.
         * This is why there is not a {@code set} method for the tilapainenUlkomainenOsoite property.</p>
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * </p>
         ...
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the Jakarta XML Binding object.
         * This is why there is not a {@code set} method for the kotimainenPostiosoite property.</p>
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * </p>
         ...
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the Jakarta XML Binding object.
         * This is why there is not a {@code set} method for the ulkomainenPostiosoite property.</p>
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * </p>
         ...
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the Jakarta XML Binding object.
         * This is why there is not a {@code set} method for the huoltaja property.</p>
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * </p>
         ...
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the Jakarta XML Binding object.
         * This is why there is not a {@code set} method for the edunvalvontavaltuutus property.</p>
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * </p>
         ...
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the Jakarta XML Binding object.
         * This is why there is not a {@code set} method for the ulkomainenHenkilonumero property.</p>
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * </p>
         ...
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the Jakarta XML Binding object.
         * This is why there is not a {@code set} method for the kansalaisuus property.</p>
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * </p>
         ...
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the Jakarta XML Binding object.
         * This is why there is not a {@code set} method for the huollettava property.</p>
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * </p>
        ...
        public static class Edunvalvonta {
             ...
             * not a snapshot. Therefore any modification you make to the
             * returned list will be present inside the Jakarta XML Binding object.
             * This is why there is not a {@code set} method for the henkiloEdunvalvoja property.</p>
             * 
             * <p>
             * For example, to add a new item, do as follows:
             * </p>
             ...
             * not a snapshot. Therefore any modification you make to the
             * returned list will be present inside the Jakarta XML Binding object.
             * This is why there is not a {@code set} method for the yritysJaYhteisoEdunvalvoja property.</p>
             * 
             * <p>
             * For example, to add a new item, do as follows:
             * </p>
             ...
             * not a snapshot. Therefore any modification you make to the
             * returned list will be present inside the Jakarta XML Binding object.
             * This is why there is not a {@code set} method for the oikeusaputoimistoEdunvalvoja property.</p>
             * 
             * <p>
             * For example, to add a new item, do as follows:
             * </p>
        ...
        public static class Edunvalvontavaltuutus {
             ...
             * not a snapshot. Therefore any modification you make to the
             * returned list will be present inside the Jakarta XML Binding object.
             * This is why there is not a {@code set} method for the henkiloEdunvalvontavaltuutettu property.</p>
             * 
             * <p>
             * For example, to add a new item, do as follows:
             * </p>
