...
public interface HenkiloModificationService {
    ...
    FindOrCreateWrapper<HenkiloPerustietoDto> findOrCreateHenkiloFromPerustietoDto(HenkiloPerustietoCreateDto henkiloPerustietoDto, boolean hasEidasLuontiRole);
